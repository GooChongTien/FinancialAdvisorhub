...
const navigationItems = [
  ...
  { title: "New Business", url: "NewBusiness", icon: Briefcase },
  { title: "Visualizer", url: "Visualizer", icon: LineChart },
  { title: "Products", url: "Product", icon: Calculator },
  ...
  useEffect(() => {
    ...
    async function checkAuth() {
      try {
        ...
        const registerPath = createPageUrl("Register");
        ...
        <div className="relative flex flex-col items-center px-2 py-6">
          <img
            ...
            className={`transition-all duration-300 ${
              sidebarCollapsed ? "h-10 w-10 object-contain" : "h-10 w-auto"
            }`}
          />
          <div
            className={cn(
        ...
        <nav className="flex flex-1 flex-col gap-4 px-2 overflow-hidden">
          ...
          >
            ...
            <ChatSidebar
              ...
              onViewAll={() => navigate(createPageUrl("ChatHistory"))}
            />
          </div>
        </nav>
          ...
          <div className="flex items-center justify-between border-b px-3 py-2">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                onClick={() => navigate(createPageUrl("ChatMira"))}
